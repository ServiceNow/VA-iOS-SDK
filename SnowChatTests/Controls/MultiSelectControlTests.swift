...
class MultiSelectControlTests: XCTestCase {
    ...
    func testMultiSelectPickerVCDefaultPresentationStyle() {
        let model = MultiSelectControlViewModel(id: "123", label: "Choice", required: true, items: multiSelectItems!, messageDate: Date())
        let multiSelectPicker = MultiSelectControl(model: model)
    
        XCTAssert(multiSelectPicker.style == .list)
    }
    ...
    func testMultiSelectSelectionWithRequiredFalse() {
        let model = MultiSelectControlViewModel(id: "123", label: "Choice", required: false, items: multiSelectItems!, messageDate: Date())
